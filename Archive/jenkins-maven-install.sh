...
mkdir /var/lib/jenkins/.m2 ###actual local directory is found in the .m2 directory### ####if we dont have the .m2 our maven will fail##
wget https://raw.githubusercontent.com/blessnwadike24/Jenkins-Maven-SonarQube-Nexus/refs/heads/main/settings.xml -P /var/lib/jenkins/.m2/  #paste your url after clicking raw from your githubaccount###########
chown -R jenkins:jenkins /var/lib/jenkins/.m2/ ########jenkinsuser has to be given access####
